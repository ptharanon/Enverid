...
class DashboardScreen(Screen):
    def __init__(self, controller, **kwargs):
        ...
        sensor3_layout, self.lbl3_co2, self.lbl3_temp, self.lbl3_rh = build_sensor_live("Sensor 3")
        sensor4_layout, self.lbl4_co2, self.lbl4_temp, self.lbl4_rh = build_sensor_live("Sensor 4")
        ...
        sensor2_calib, self.lbl2_baseline, self.lbl2_exposure, self.lbl2_vented = build_sensor_calib("Sensor 2 Calibration")
        sensor3_calib, self.lbl3_baseline, self.lbl3_exposure, self.lbl3_vented = build_sensor_calib("Sensor 3 Calibration")
        sensor4_calib, self.lbl4_baseline, self.lbl4_exposure, self.lbl4_vented = build_sensor_calib("Sensor 4 Calibration")
